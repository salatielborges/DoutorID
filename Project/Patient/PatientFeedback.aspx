...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <br /><br />
    <asp:Label ID="Message" runat="server" Visible="false"  Font-Bold="true" Font-Size="Medium">Caro paciente, Como foi sua experiência de tratamento com nosso médico especialista com uma classificação de 1 - 5:</asp:Label>
    ...
    <div  style="margin-left: 790px">
        ...
        <asp:Button ID="button1" runat="server" Visible="false" OnClick="giveFeedback"  Text ="Comentário" Font-Bold ="true" />
