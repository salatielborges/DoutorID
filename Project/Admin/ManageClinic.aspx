...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        ...
        <h4 style="font:bold">Selecione :</h4>
        <br />

           <asp:RadioButton name="Gender" OnCheckedChanged="RadioButton_CheckedChanged"
             AutoPostBack="true" id="Doctor" GroupName="Catagory" runat="server" Text="Médicos" checked="true" value ="D" />
                                                            
           <asp:RadioButton name="Gender" OnCheckedChanged="RadioButton_CheckedChanged"
             AutoPostBack="true" id="Patient" GroupName="Catagory" runat="server" Text="Pacientes" value ="P" />

           <asp:RadioButton name="Gender"  OnCheckedChanged="RadioButton_CheckedChanged"
             AutoPostBack="true" id="OtherStaff" GroupName="Catagory" runat="server" Text="Funcionários" value ="O" />
        ...
        <asp:button Text ="Pesquisar"  runat="server" type="submit" class="btn btn-primary"  OnClick="Search_btn" ></asp:button>
        <br />
